...
这部分主要讲怎么理解这个框架。字段名、命令、签名那些细节，去看[参考](/reference/README.md)。想照着步骤做事，去看[指南](/guides/README.md)。这里要解决的是：你先把脑子里的图搭起来，后面读别的文档才不费劲。
...
- [指南](/guides/README.md) — 按步骤做事。
- [参考](/reference/README.md) — 查命令、API 和字段。
- [开发](/dev/README.md)（英文） — 给贡献者看的内部文档。