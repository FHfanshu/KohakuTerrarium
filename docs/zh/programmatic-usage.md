...
如果你要在 Python 里做多 agent 流水线，但不想上 terrarium，看[组合](/zh/composition.md)。
...
- [组合](/zh/composition.md) —— Python 侧的多 agent 流水线。
- [自定义模块](/zh/custom-modules.md) —— 自己写并接入 tool、input、output。
